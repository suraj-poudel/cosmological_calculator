# python suraj_cosmological_calculator.py
#!/usr/bin/env python
...
import numpy as np
import math
data=Table.read('oh1.txt', format='ascii')
#H0=70
WM=0.3
WV=0.7
z=data['col1']
H0=data['col2']
for x1,x2 in zip(z,H0):
  z=x1
  H0=x2
...
# comoving volume computation
  ...
  #print '%1.3f' % zage_Gyr,
  #print '%1.3f' % DCMR_Mpc,
  #print '%1.6f' % z,'%1.3f' % kpc_DA
  print '%1.3f' % kpc_DA
  #ascii.write([y1,y2], 'separation_result.txt', names=['z', 'scale'], overwrite=True)
  #print '%1.3f' % (5*log10(DL_Mpc*1e6)-5)